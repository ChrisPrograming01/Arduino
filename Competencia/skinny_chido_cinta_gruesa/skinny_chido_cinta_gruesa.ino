///---Define's---///
#define MAX_SPEED 140  //Velocidad maxima de correccion fuera de una recta, valor maximo 255
#define MED_SPEED 70 //Velocidad en rectas, valor maximo 255
#define OUT_LINE 10   //valor dado para fuera de linea, no modificar
#define KP 2        //Valor de constante Kp del PID
...
signed int read_error() {
  ...
  if (b[0] || b[1] || b[2] || b[3] || b[4]) { //Si cualquier sensor esta en linea negra
    ...
    if (b[0] == 1 && b[1] == 1 && b[2] == 1) {
      error = -2;
    } else if (b[1] && b[2] == 1 && b[3] == 1) {
      error = 0;
    } else if (b[2] == 1 && b[3] == 1 && b[4] == 1) {
      error = 2;
    }
