///---Define's---///
#define MAX_SPEED 100                                              //Velocidad maxima en curvas, valor maximo 255
#define MED_SPEED 50                                              //Velocidad en rectas, valor maximo 255
...
int Read_error (void){
  ...
  b4=!(digitalRead(6));
  b5=!(digitalRead(7));
  b6=!(digitalRead(8)); // sensor enmedio
  b7=!(digitalRead(12));
  b8=!(digitalRead(14));
  b9=!(digitalRead(15));
  b10=!(digitalRead(16));
